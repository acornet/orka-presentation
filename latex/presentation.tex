...
$$ cost(routine) = \sum_{line \in routine} cost(line) = \sum_{line \in routine} \sum_{API \in line} cost(API)$$
...
\item Hence, need to compute $\{API \in line\}$
...
%
%
\begin{frame}{Analyser} % Replay of Logcat and call stacks
