...
After reviewing the related work...\alert{extending an existing solution}, namely Orka = option to fulfill them.\\
}
\note[item]{
...
tail-energy is responsible for a \alert{significant fraction} of the drain\\~\\
Map: this method is method is responsible for this drain
}
\end{frame}
%
%
...
Important effort were made to \alert{refactor}\\
...
\end{itemize}
\note{
test env allow to enter one command to run the eval\\
petra = software based tools released in March\\
...
\note{\alert{what I'd like to leave to with}}
\end{frame}
%
%
\begin{frame}
